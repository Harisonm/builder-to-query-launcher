...
FROM (
  ...
  FROM
    `plateforme-fournisseurs-prod.datamarts_fournisseurs.insights_ecommerces_trafic` )
UNION ALL (
  SELECT
  ...
  FROM
    `plateforme-fournisseurs-prod.datamarts_fournisseurs.insights_ecommerces_trafic` ecom
  JOIN
