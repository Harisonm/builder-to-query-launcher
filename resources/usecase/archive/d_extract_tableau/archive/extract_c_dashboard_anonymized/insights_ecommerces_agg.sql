...
FROM (
  ...
  FROM
    `plateforme-fournisseurs-prod.datamarts_fournisseurs.insights_ecommerces_agg` )
UNION ALL (
  SELECT
  ...
  FROM
    `plateforme-fournisseurs-prod.datamarts_fournisseurs.insights_ecommerces_agg` ecom
  JOIN
