...
FROM (
  ...
  FROM
    `plateforme-fournisseurs-prod.datamarts_fournisseurs.insights_ecommerces_mot_cle_agg` )
UNION ALL (
  SELECT
  ...
  FROM
    `plateforme-fournisseurs-prod.datamarts_fournisseurs.insights_ecommerces_mot_cle_agg` ecom
  JOIN
